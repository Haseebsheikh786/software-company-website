...
const AboutUs = () => {
  return (
    <>
      <div className="about-section">
        ...
        <div className="cards-container">
          ...
          <Card className=" about-card">
            <h3>Our Mission</h3>
            <p>
              Our mission to make happy clients and provide them work with full
      ...
      <div className="AboutContainer AboutContainerColor ">
        ...
        <div className="col-sm-12 col-lg-6 serviceProcessList">
          ...
          <p>
            Developing a website and mobile app is a masterful field. NEXTPAK
            AGILE SOLUTIONS is a cross-useful software advancement organization
            focused on planning and conveying new computerized tools and
            services to organizations across enterprises and verticals. We stick
            to a proactive, dynamic, and result-situated way to deal with and
            guarantee that we bring typically effective results. We are
            energetic about what we do. Our architects and digital analysts
            utilize their strong aptitude to offer achievement arranged vectors
            for our customers. Client assistance engineers guarantee the
            apparatuses we work for our customers to satisfy their clients.
          </p>
        </div>
      </div>
